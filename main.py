...
from tools import get_user_input_ch, \
    get_player_name, get_player_race, get_player_job, \
    translate_race_str_to_enum, translate_job_str_to_enum, \
    generate_random_stats, handle_new_game_stats,  \
    new_character, handle_input, quick_new_character 
import Game
import Renderer
...
def main(stdscr):
    ...
    if cc=='n':
        ...
        pc.y = 0 # when drawing pc or anything in dungeon, have to account for offset of borders
        pc.x = 0
